...
#define DEV_DBG_EN      0
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[OV8820_2lane]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[OV8820_2lane]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[OV8820_2lane]"x,##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	{0x3503, 0x17}, 		  //Gain delay to next frame, VTS manual, AGC manual, AEC manual
	...
	//;MIPI  
	{0x4800, 0x04}, 		  //clock lane free running, do not send line short packet, use lane 1 as default data lane, MIPI bus will be LP11 when there is not packet to transmit
...
//	printk("8820 sensor_set_gain = %d, 0x%x, 0x%x Done!\n", gain_val,gainlow, gainhigh );
	info->gain = gain_val;
