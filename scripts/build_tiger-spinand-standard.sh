...
#local NFSROOT=/home/dev/sunxi/fs/nfs/buildroot-v3s-uclibc/
#local PACKROOT=/home/dev/v3smv/spinand/camdroid/out/target/product/tiger-spinand-standard/system/
	update_kern_ver
