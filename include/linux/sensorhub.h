...
//#define SENSORHUB_I2C_ADDR     0x18
#define SENSORHUB_I2C_ADDR_ALT 0x49
#define SENSORHUB_VERSION "v1.2.1"

/**
 * Device firmware upgrade methods
 */
enum sensorhub_dfu_type {
	SENSORHUB_DFU_NONE,
	SENSORHUB_DFU_ATMEL_V1,
	SENSORHUB_DFU_STM32F_V1,
	SENSORHUB_DFU_BNO_V1,
};

/**
 * Device specific configuration structure.
 * These configuration values are specific to a particular board and have to
 * be provided as part of the board config.
 */
struct sensorhub_platform_data {
	/**
	 * The firmware update method for this device
	 */
	enum sensorhub_dfu_type dfu_type;
	/**
	...
	int gpio_wakeup;
	/**
	 * A boot mode pin for some Sensorhubs.
