...
ieee80211_tx_h_unicast_ps_buf(struct ieee80211_tx_data *tx)
{
	...
	if (unlikely((test_sta_flag(sta, WLAN_STA_PS_STA) ||
		...
		/* start --add by yangfh refer to backports-3.16.1 */
		...
		/* end --add by yangfh refer to backports-3.16.1 */
		...
		spin_unlock(&sta->ps_lock);  /* add by yangfh refer to backports-3.16.1 */
